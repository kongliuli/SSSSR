...
namespace Shadowsocks.Encryption.Stream
{
    public abstract class StreamEncryptor : EncryptorBase
    {
        ...
        // BufferSize constant (18497) - inlined to break Encryption->Proxy circular dependency
        private readonly ByteCircularBuffer _encCircularBuffer = new(18497 * 2);
        private readonly ByteCircularBuffer _decCircularBuffer = new(18497 * 2);
