...
namespace Shadowsocks.Controller
{
    public class MenuViewController
    {
        ...
        private void ShowMainWindow(Type initialPage = null)
        {
            if (_mainWindow != null)
            {
                ...
                _mainWindow.NavigateTo(initialPage);
            }
            else
            {
                _mainWindow = AppHost.Get<MainWindow>();
                _mainWindow.InitialPage = initialPage;
        ...
        {
            ShowMainWindow(typeof(ServersPage));
        }
        ...
        {
            ShowMainWindow(typeof(SettingsPage));
        }
        ...
        {
            ShowMainWindow(typeof(PortForwardingPage));
        }

        private void ShowServerLogForm()
        {
            ShowMainWindow(typeof(StatisticsPage));
        }

        private void ShowGlobalLogWindow()
        {
            ShowMainWindow(typeof(LogsPage));
        }

        private void ShowSubscribeSettingForm()
        {
            ShowMainWindow(typeof(SubscriptionsPage));
        }
