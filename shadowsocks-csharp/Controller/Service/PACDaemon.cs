    ...
    public class PACDaemon
    {
        ...
        private void PACFileWatcher_Changed(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                ...
                _ = Task.Delay(10).ContinueWith(task => { PACFileChanged(this, EventArgs.Empty); }, TaskScheduler.Default);
            }
            finally
            {
        ...
        private void UserRuleFileWatcher_Changed(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                ...
                _ = Task.Delay(10).ContinueWith(task => { UserRuleFileChanged(this, EventArgs.Empty); }, TaskScheduler.Default);
            }
            finally
            {
                ((FileSystemWatcher)sender).EnableRaisingEvents = true;
